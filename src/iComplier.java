/* Generated By:JJTree&JavaCC: Do not edit this line. iComplier.java */
import java.util.*;
import java.io.*;

public class iComplier extends Exception/*@bgen(jjtree)*/implements iComplierTreeConstants, iComplierConstants {/*@bgen(jjtree)*/
  protected static JJTiComplierState jjtree = new JJTiComplierState();private static String switch_expr;
    ...
    public static void main(String args[]) throws ParseException, IOException, Exception {
      String name = args[0];
      iComplier parser = new iComplier(new FileInputStream("../Input/"+name+ ".txt"));
      symTab.addSysFunc();
      OutputStream osir=new FileOutputStream("../Output/Intermediate_Representation/Ir_" + name + ".txt");
      OutputStream ossym=new FileOutputStream("../Output/Symbol_table/Symtab_" + name + ".txt");
      pr_ir = new PrintWriter(osir);
      pr_sym = new PrintWriter(ossym);
      {
        System.out.println("Reading from file ...");
        try {
          SimpleNode n = iComplier.Start();
...
// 将Token对象赋给了临时变量tok，并且返回tok中image属性的值作为name()的语义值
 ...
 /*@bgen(jjtree) name */
  ...
  static public iComplierTokenManager token_source;
  ...
  public iComplier(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public iComplier(java.io.InputStream stream, String encoding) {
    ...
    token_source = new iComplierTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public iComplier(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  public iComplier(iComplierTokenManager tm) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(iComplierTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
